...
// MIT license
//
// rellaxLimits added by Harry Park
//
...
(function (root, factory) {
  ...
  var Rellax = function(el, options){
    ...
    var createBlock = function(el) {
      ...
      var dataLimit = el.getAttribute('data-rellax-limit');
  ...
  // Checks limits of each block
    var limitCheck = function(dataLimit, pos) {
      dataLimit = dataLimit.split(', ');
      var topLimit = dataLimit[0];
      var bottomLimit = dataLimit[1];

      if (pos >= topLimit && pos <= bottomLimit) {
        return true;
      } else {
        return false;
      }
    ...
    // Checks to see if in range of limits
        if (limitCheck(blocks[i].limits, position)) {
          // Move that element
